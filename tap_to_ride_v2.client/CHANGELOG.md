...
- Create Angular project with ng: `ng new "tap_to_ride_v2.client" --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`tap_to_ride_v2.client.esproj`).
